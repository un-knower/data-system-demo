...
public class DataFileSimulation{
	...
	private int producer_num;
	private int bufferSize;
	private Producer producer;
	private Consumer consumer;
	private final String producerDirectory;
	public DataFileSimulation(int producer_num,int bufferSize,long timeout,int logInterval,String logDirectory,int maxWrongNum,String producerDirectory){
		...
		//create producer
		producer = new Producer(producerDirectory, producer_num, queue);
